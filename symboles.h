...
extern type_variable table_ident_fonctions[NBRE_FONCTIONS_MAX][NBRE_IDENT_MAX];	// two dimensional array , xaxis = numero function, yaxis = identifier of function
extern int table_nbre_variables[NBRE_FONCTIONS_MAX];	// counts number of variables for each array in table_ident_fonctions
